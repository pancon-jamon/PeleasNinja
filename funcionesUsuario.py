...
def listarNinjas():
    ...
    print(f"El numero de ninjas que hay es de {len(estructuras.estructuraDiccionarioNinjas)}")
    print("Ordenar por:")
    print("1. Nombre (A-Z)")
    ...
    if opcion == "1":
        ninjas_ordenados = sorted(estructuras.estructuraDiccionarioNinjas.items())
    elif opcion == "2":
        ninjas_ordenados = sorted(estructuras.estructuraDiccionarioNinjas.items(), key=lambda x: x[1][4], reverse=True)
    else:
...
def pelea(ninja1,ninja2):
        datos1 = estructuras.estructuraDiccionarioNinjas[ninja1]
        datos2 = estructuras.estructuraDiccionarioNinjas[ninja2]
        print(f"{ninja1} VS {ninja2}")
        print(f"{ninja1}\nEstadisticas:\nFuerza: {datos1[0]}\nAgilidad: {datos1[1]}\nResistencia: {datos1[2]}\nEstilo de pelea: {datos1[3]}\nPuntos: {datos1[4]}\n")
        print(f"{ninja2}\nEstadisticas:\nFuerza: {datos2[0]}\nAgilidad: {datos2[1]}\nResistencia: {datos2[2]}\nEstilo de pelea: {datos2[3]}\nPuntos: {datos2[4]}\n")
        if estructuras.estructuraDiccionarioNinjas[ninja1][4]<estructuras.estructuraDiccionarioNinjas[ninja2][4]:
